...
basis: `jh.py exec 'cd ~ && rm -f ~/setup.rc && mv ... && setsid nohup bash ~/setup2.sh > ~/setup.log 2>&1 < /dev/null & sleep 2; ...' 20` raised `websocket._exceptions.WebSocketTimeoutException: Connection timed out` at home while a fresh kernel showed `3463028 bash /home/jupyter-box-a/setup2.sh` running and `setup.log` advancing.
