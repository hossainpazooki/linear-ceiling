...
status: verified
fact: The E9 backup dataset anon/linear-ceiling-e9-2026-09-04 is private in a user
...
basis: `GET /api/datasets/anon/linear-ceiling-e9-2026-09-04/collaborators` -> 404 "Sorry, we
  can't find the page you are looking for."; `GET /api/datasets/anon/linear-ceiling-e9-2026-09-04`
  -> 200 private=True (captured 2026-09-05T02:23:03Z with the owner's token); whoami-v2 token scopes
  `[('anon/linear-ceiling-e9-2026-09-04', ['repo.access.read', 'repo.content.read', 'repo.write'])]`;
...
re-verify: curl -s -o /dev/null -w "%{http_code}\n" -H "Authorization: Bearer $HF_TOKEN" https://huggingface.co/api/datasets/anon/linear-ceiling-e9-2026-09-04/collaborators
