> **ARCHIVED 2026-09-09.** The status-form README as it stood at commit `b4b56aa` (2026-09-09), written around the E9 freeze. Superseded by the objective-first README when the program re-cut the LCFM paper (entry 0035). Kept verbatim; its status lines are stale. The live README is `/README.md`.
