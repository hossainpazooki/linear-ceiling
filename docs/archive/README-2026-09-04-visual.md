> **ARCHIVED 2026-09-09.** The visual-heavy README as it stood at commit `7ce63cf` (2026-09-04), before the 2026-09-06 rework to aims + status. Kept verbatim for its diagrams; every status line in it is stale. The live README is `/README.md`.
