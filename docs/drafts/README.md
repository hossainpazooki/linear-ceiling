...
Current state: **no drafts pending.** Entries 0013–0020 are all appended and their scripts
deleted. The next expected entry is **0021 — the H-E9 verdict**, written from a clean
