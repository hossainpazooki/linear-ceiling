"""Append entry 0042 -- the E9 short cell of the second model family RAN; the H-E9F verdict, written ONLY
...
Ordering guard: 0041 on the ledger, 0042 absent, the H-E9F row present and still `unresolved`. The band
