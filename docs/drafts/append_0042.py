"""Append entry 0042 -- the E9 SHORT cell of the second model family, registered BEFORE any prefill, with
...
Ordering guard: 0040 present, 0042 absent, and no H-E9F row in the table yet. Nothing under this entry may
